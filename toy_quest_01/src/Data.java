...
public class Data {
    ...
    public final Map<Integer, QuestionDto> questions;

    public Data() {
        questions = new HashMap<>();

        questions.put(1, new QuestionDto(
        ...
        questions.put(2, new QuestionDto(
        ...
        questions.put(3, new QuestionDto(
        ...
        questions.put(4, new QuestionDto(
